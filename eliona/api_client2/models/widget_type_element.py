...
class WidgetTypeElement(BaseModel):
    ...
    def category_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['input', 'table', 'image', 'tickets', 'map', 'icon', 'range', 'donut', 'comfort', 'sankey', 'progress', 'tracking', 'heatmap', 'radar', 'value', 'calendar', 'trend', 'alarms', 'weather', 'storey']):
