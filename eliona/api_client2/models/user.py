...
class User(BaseModel):
    ...
    An user
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The internal ID of user")
    firstname: Optional[StrictStr] = Field(default=None, description="The user's firstname")
    lastname: Optional[StrictStr] = Field(default=None, description="The user's lastname")
    email: StrictStr = Field(description="Address of the user")
