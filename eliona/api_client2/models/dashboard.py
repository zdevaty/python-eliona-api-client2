...
class Dashboard(BaseModel):
    ...
    public: Optional[StrictBool] = Field(default=False, description="Is the dashboard public and not bound to a dedicated user")
    __properties: ClassVar[List[str]] = ["id", "name", "projectId", "userId", "sequence", "widgets", "public"]
