...
class AssetListen(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["resourceId", "id", "deviceIds", "projectId", "globalAssetIdentifier", "name", "assetType", "latitude", "longitude", "isTracker", "trackerId", "description", "parentFunctionalAssetId", "functionalAssetIdPath", "parentLocationalAssetId", "locationalAssetIdPath", "parentFunctionalIdentifier", "parentLocationalIdentifier", "tags", "allowedInactivity", "childrenInfo", "attachments", "statusCode"]
