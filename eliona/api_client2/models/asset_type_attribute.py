...
class AssetTypeAttribute(BaseModel):
    ...
    enable: Optional[StrictBool] = Field(default=False, description="Is data active or not")
    ...
    aggregation_mode: Optional[StrictStr] = Field(default=None, description="Deprecated: Use the 'GET /data-trend-aggregated' endpoint to retrieve aggregated data for periodic rasters without defining aggregations. Aggregation calculation mode. ", alias="aggregationMode")
