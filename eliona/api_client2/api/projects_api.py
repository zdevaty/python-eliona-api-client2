...
class ProjectsApi:
    ...
    def _get_project_by_id_serialize(
        ...
        if project_id is not None:
            _path_params['project-id'] = project_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{project-id}',
    ...
    @validate_call
    def get_project_role_by_name(
        self,
        role_name: Annotated[StrictStr, Field(description="The name of the role")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_project_role_by_name_serialize(
            role_name=role_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_project_role_by_name_with_http_info(
        self,
        role_name: Annotated[StrictStr, Field(description="The name of the role")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_project_role_by_name_without_preload_content(
        self,
        role_name: Annotated[StrictStr, Field(description="The name of the role")],
        _request_timeout: Union[
            None,
    ...
    def _get_project_role_by_name_serialize(
        self,
        role_name,
        _request_auth,
        _content_type,
        ...
        if role_name is not None:
            _path_params['role-name'] = role_name
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project-roles/{role-name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def put_project(
        ...
        _param = self._put_project_serialize(
            project=project,
            expansions=expansions,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def put_project_without_preload_content(
        self,
        project: Optional[Project],
        expansions: Annotated[Optional[List[StrictStr]], Field(description="List of referenced data to load, insert or update. Each entry defines the full qualified name of the field to be expanded as follows 'ObjectName.fieldName'.")] = None,
        _request_timeout: Union[
    ...
    def put_project_role(
        ...
        _param = self._put_project_role_serialize(
    ...
    @validate_call
    def put_project_role_with_http_info(
        self,
        project_role: Optional[ProjectRole],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def put_project_role_without_preload_content(
        self,
        project_role: Optional[ProjectRole],
        _request_timeout: Union[
            None,
    ...
    def _put_project_role_serialize(
        self,
        project_role,
        _request_auth,
        _content_type,
    ...
    def stream_project_roles(
        ...
        _param = self._stream_project_roles_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def stream_project_roles_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def stream_project_roles_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _stream_project_roles_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project-roles-stream',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
