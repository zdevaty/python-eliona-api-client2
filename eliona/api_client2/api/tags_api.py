...
class TagsApi:
    ...
    def get_tag_by_name(
        ...
        _param = self._get_tag_by_name_serialize(
            tag_name=tag_name,
    ...
    @validate_call
    def get_tag_by_name_with_http_info(
        self,
        tag_name: Annotated[StrictStr, Field(description="The name of the tag")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tag_by_name_without_preload_content(
        self,
        tag_name: Annotated[StrictStr, Field(description="The name of the tag")],
        _request_timeout: Union[
            None,
    ...
    def _get_tag_by_name_serialize(
        self,
        tag_name,
        _request_auth,
        _content_type,
        ...
        if tag_name is not None:
            _path_params['tag-name'] = tag_name
