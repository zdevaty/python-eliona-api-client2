...
class QRCodesApi:
    ...
    def get_qr_code_by_asset_id(
        ...
        _param = self._get_qr_code_by_asset_id_serialize(
            asset_id=asset_id,
    ...
    @validate_call
    def get_qr_code_by_asset_id_with_http_info(
        self,
        asset_id: Annotated[StrictInt, Field(description="The id of the asset")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_qr_code_by_asset_id_without_preload_content(
        self,
        asset_id: Annotated[StrictInt, Field(description="The id of the asset")],
        _request_timeout: Union[
            None,
    ...
    def _get_qr_code_by_asset_id_serialize(
        self,
        asset_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/qr-codes/assets/{asset-id}',
