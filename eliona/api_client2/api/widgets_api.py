...
class WidgetsApi:
    ...
    def get_dashboard_widgets(
        ...
        _param = self._get_dashboard_widgets_serialize(
    ...
    @validate_call
    def get_dashboard_widgets_with_http_info(
        self,
        dashboard_id: Annotated[StrictInt, Field(description="The id of the dashboard")],
        expansions: Annotated[Optional[List[StrictStr]], Field(description="List of referenced data to load, insert or update. Each entry defines the full qualified name of the field to be expanded as follows 'ObjectName.fieldName'.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_dashboard_widgets_without_preload_content(
        self,
        dashboard_id: Annotated[StrictInt, Field(description="The id of the dashboard")],
        expansions: Annotated[Optional[List[StrictStr]], Field(description="List of referenced data to load, insert or update. Each entry defines the full qualified name of the field to be expanded as follows 'ObjectName.fieldName'.")] = None,
        _request_timeout: Union[
    ...
    def _get_dashboard_widgets_serialize(
        self,
        dashboard_id,
        expansions,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dashboards/{dashboard-id}/widgets',
    ...
    def post_dashboard_widget(
        ...
        _param = self._post_dashboard_widget_serialize(
            dashboard_id=dashboard_id,
            widget=widget,
            expansions=expansions,
            _request_auth=_request_auth,
    ...
    @validate_call
    def post_dashboard_widget_with_http_info(
        self,
        dashboard_id: Annotated[StrictInt, Field(description="The id of the dashboard")],
        widget: Widget,
        expansions: Annotated[Optional[List[StrictStr]], Field(description="List of referenced data to load, insert or update. Each entry defines the full qualified name of the field to be expanded as follows 'ObjectName.fieldName'.")] = None,
    ...
    @validate_call
    def post_dashboard_widget_without_preload_content(
        self,
        dashboard_id: Annotated[StrictInt, Field(description="The id of the dashboard")],
        widget: Widget,
        expansions: Annotated[Optional[List[StrictStr]], Field(description="List of referenced data to load, insert or update. Each entry defines the full qualified name of the field to be expanded as follows 'ObjectName.fieldName'.")] = None,
    ...
    def _post_dashboard_widget_serialize(
        self,
        dashboard_id,
        widget,
        expansions,
